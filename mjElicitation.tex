...
\begin{figure}
	\centering
		\begin{tikzpicture}
			\begin{axis}[
				ylabel=Prob. \%,
				xlabel=Grades Better than Med. \%,
				ymin=0,
				ymax=40,
				xmin=5338,
				xmax=10675,
				xtick={5339,6405,7472,8540,9607,10675},
				xticklabels={50,60,70,80,90,100}
				]
				\addplot[thick, red] table [x=Percentage, y=ProbOfMiss]{data/distr.dat};			
			\end{axis}
		\end{tikzpicture}
...
\begin{figure}
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot[thick, blue] table [x=k, y=ProbOfMiss]{data/changingK.dat};			
		\end{axis}
	\end{tikzpicture}
...
\begin{table}
	...
	\begin{tabular}{S[table-figures-integer=3, table-figures-decimal=0]S[table-figures-integer=3, table-figures-decimal=2]}
			...
			\bottomrule
		\end{tabular}
	\caption{Detailed numbers of \Cref{fig:differentK}.}
...
\begin{example}
%	 Consider the complete profile $P$ of \Cref{prop:notsamewinner}. Assume that each voter only express its best and worst judgments and construct the complete profile $P'$ from $P$ in the following way: for each alternative that is not the real winner add as many voters as needed such that its known median grade is better than the known median grade of the real winner, add an additional alternative that is rejected by all these new voters. Since the voters only express the best and the worst grades, we can assume that they judge the rest of the alternatives according to the current known median. The resulting profile $P'$ is: 
	 ...
	 \begin{center}
	 	...
	 	\begin{array}{cccccccc}
	 		...
	 		a	&	Average	&	Average	&	Excellent	&	Average	&	Average	&	Average	&	Average	\\
	 		b	&	To be rejected	&	Good	&	Good	&	Good	&	Good	&	Good	&	Good	\\
	 		c	&	Mediocre	&	Excellent	&	Mediocre	&	Mediocre	&	Mediocre	&	Mediocre	&	Mediocre	\\
	 		d	&	Average	&	Average	&	To be rejected	&	Excellent	&	Excellent	&	Average	&	Average	\\
	 		e	&	Mediocre	&	To be rejected	&	Mediocre	&	Mediocre	&	Mediocre	&	Excellent	&	Excellent	\\
	 		f	&	Excellent	&	Inadequate	&	Inadequate	&	Inadequate	&	Inadequate	&	Inadequate	&	Inadequate	\\
	 		g	&	To be rejected	&	To be rejected	&	To be rejected	&	To be rejected	&	To be rejected	&	To be rejected	&	To be rejected	\\	 		
	 	\end{array} \quad.
	 	$}
	 \end{center}
