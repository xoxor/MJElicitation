...
\begin{proposition}
	...
	Given $A$ the set of $m\geq 3$ alternatives, $N$ the set of $n\geq3$ voters and any integer $k \in \intvl{1,m-1}$, there exist a complete profile $P$ and an incomplete profile $\bar{P^k}$, such that $P \in C(\bar{P^k})$ and $F_{maj}(P) \nsubseteq \bar{W}$.
\end{proposition}
\begin{proof}
